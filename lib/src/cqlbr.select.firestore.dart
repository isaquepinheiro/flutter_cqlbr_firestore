...
import 'package:flutter_cqlbr_firestore/src/cqlbr.delete.firestore.dart';

import 'cqlbr.functions.firestore.dart';
...
class CQLSelectFirestore extends CQLSelect {
  ...
  CQLSelectFirestore(this.instance) {
    ...
    CQLBrRegister.instance.registerFunctions(driver, CQLFunctionsFirestore());
  }
